...
def main():
    ...
    radar_image = ax.imshow(antenna_img, extent=[radar_station[0] - 50, radar_station[0] + 50, radar_station[1] - 50,
                                                 radar_station[1] + 50])
    radar_angle = 0  # Initialize radar angle
    radar_angle_scale = tk.Scale(root, from_=0, to=360, orient="horizontal", label="Radar Angle",
                                 command=update_radar_angle)
